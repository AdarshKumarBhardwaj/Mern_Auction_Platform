      ...
      >
        <div className="relative">
          ...
          <ul className="flex flex-col gap-3">
            ...
            {!isAuthenticated ? (
              <>
                <div className="my-4 flex gap-2">
                  <Link
                    to={"/sign-up"}
                    className="bg-[#D64428] font-semibold hover:bg-[#b8341e] text-xl py-1 px-4 rounded-md text-white"
                  >
                    Sign Up
                  </Link>
                  <Link
                    to={"/login"}
                    className="text-[#DECCBE] bg-transparent border-[#DECCBE] border-2 py-1 px-4 rounded-md hover:bg-[#fffefd] hover:text-[#fdba88] font-bold text-xl"
                  >
                    Login
                  </Link>
                </div>
              ...
              <>
                <div className="my-4 flex gap-4 w-fit" onClick={handleLogout}>
                  <button className="bg-[#D64428] font-semibold hover:bg-[#b8341e] text-xl py-1 px-4 rounded-md text-white">
                    Logout
                  </button>
                </div>
              </>
            ...
            <IoMdCloseCircleOutline
              onClick={() => setShow(!show)}
              className="absolute top-0 right-4 text-[24px] sm:hidden"
            />
          </ul>
        </div>
        ...
        <div>
          <div className="flex gap-2 items-center mb-2">
            <Link
              to="/"
              className="bg-white text-stone-500 p-2 text-xl rounded-sm hover:text-blue-700 hover:transition-all hover:duration-150"
            >
              <FaFacebook />
            </Link>
            <Link
              to="/"
              className="bg-white text-stone-500 p-2 text-xl rounded-sm hover:text-pink-500 hover:transition-all hover:duration-150"
            >
              <RiInstagramFill />
            </Link>
          </div>
