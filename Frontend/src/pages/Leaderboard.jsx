...
const Leaderboard = () => {
  ...
  return (
    <>
      <section className="w-full gap-7 ml-0 m-0 h-fit px-5 pt-10 lg:pl-[320px] flex flex-col ">
        {loading ? (
          <Spinner />
        ) : (
          <>
              ...
              <table className="min-w-full bg-white border my-5 border-gray-300">
                <thead>
                  <tr>
                    ...
                    <th className="py-2 px-4 text-left">Expenditure</th>
                  ...
                  {leaderboard.slice(0, 100).map((element, index) => {
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-2">{element.userName}</td>
                        <td className="px-4 py-2">{element.moneySpent}</td>{" "}
                        <td className="px-4 py-2">{element.auctionWon}</td>
                      </tr>
                    );
                  })}
                </tbody>
