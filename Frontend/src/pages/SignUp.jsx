...
const SignUp = () => {
  ...
  const [paytmAccountNumber, setPaytmAccountNumber] = useState("");
  ...
  const handleRegister = (e) => {
    ...
    role === "Auctioneer" &&
      ...
      formData.append("paytmAccountNumber", paytmAccountNumber),
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <input
                    type="number"
                    value={paytmAccountNumber}
                    placeholder="Paytm Account Number"
                    onChange={(e) => setPaytmAccountNumber(e.target.value)}
                    className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1"
                    disabled={role === "Bidder"}
                  />
                  <input
